...
class UnifiedEventService:
    ...
    async def create_event_hierarchy(
        ...
        if not track:
            ...
            # Write file if not exists (hash check suggests it shouldn't, but safely)
            ...
            # Tags / AI Inference (Optional - skipping AI for speed/simplicity in this unified flow unless requested?)
            # Let's do basic inference
            ...
            track = models.Track(
                ...
                activity_type=models.ActivityType.TRAIL_RUNNING, # Default for races usually
                visiblity=models.Visibility.PUBLIC,
